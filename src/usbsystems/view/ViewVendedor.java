...
import usbsystems.model.Endereco;
import usbsystems.model.Vendedor;
...
public class ViewVendedor {
    ...
    private static Vendedor cadastrarVendedor() {
        ...
        System.out.println("Informe as vendas semestrais: ");
        vendedor.setVendasSemenstrais(sc.nextInt());
        return vendedor;
    }
